...
import { ArrowUpRight, Heart, ScanFace, Sparkles } from 'lucide-react';
import { site } from '@/data/site';

const pillars = [
  { title: 'Identidade', copy: 'Seus traços são o ponto de partida, nunca algo a ser apagado.', Icon: ScanFace },
  { title: 'Naturalidade', copy: 'Escolhas precisas para valorizar sua expressão sem excessos.', Icon: Sparkles },
  ...
  return <section id="manifesto" className="essence-editorial" ref={root} aria-labelledby="essence-title">
    <div className="essence-stage">
      ...
      <figure className="essence-smile" data-essence-motion="photo">
        <Image src={site.images.hero} alt="Retrato editorial da Dra. Daniella Félix" fill sizes="(max-width:700px) 180vw, (max-width:1100px) 82vw, 67vw"/>
      </figure>
      ...
      <div className="essence-editorial-copy">
        <p className="essence-editorial-prelude" data-essence-motion="fade">Cada contorno conta uma história.</p>
        ...
        <p className="essence-editorial-description" data-essence-motion="fade" data-delay="350">Cuidar da sua beleza é valorizar seus traços, suas proporções e tudo o que torna você única.</p>
